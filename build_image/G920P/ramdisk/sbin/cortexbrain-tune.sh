...
cortexbrain_kernel=$(cat /res/synapse/Hybridmax/cortexbrain_kernel);
cortexbrain_system=$(cat /res/synapse/Hybridmax/cortexbrain_system);
cortexbrain_wifi_auto=$(cat /res/synapse/Hybridmax/cortexbrain_wifi_auto);
cortexbrain_media_manager=$(cat /res/synapse/Hybridmax/cortexbrain_media_manager);
cortexbrain_nmi_auto=$(cat /res/synapse/Hybridmax/cortexbrain_nmi_auto);
